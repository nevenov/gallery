...
?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <!-- Author -->
                <p class="lead">
                    by <a href="index.php?user_id=<?php echo $photo->user_id; ?>">
                    <?php 
                ...
                <!-- Date/Time -->
                <p><span class="glyphicon glyphicon-time"></span> Posted on <?php echo Photo::photo_date($photo->id); ?><!-- August 24, 2013 at 9:00 PM --></p>
                ...
                <div class="media">
                    ...
                    <div class="media-body">
                        <h4 class="media-heading"><?php echo $comment->author; ?>
                            <small><?php echo Comment::comment_date($comment->id); ?> <!-- August 25, 2014 at 9:30 PM --></small>
                        </h4>
