...
if (empty($_GET['id'])) {
    ...
    if (isset($_POST['update'])) {
        ...
        if ($photo) {
            ...
            $message = "The photo {$photo->id} has been updated.";
                            ...
                            <div class="col-md-4">
                                <div  class="photo-info-box">
                                    ...
                                    <div class="inside">
                                      <div class="box-inner">
                                         <p class="text">
                                           <span class="glyphicon glyphicon-calendar"></span> Uploaded on: <?php echo Photo::photo_date($photo->id); ?>  <!-- April 22, 2030 @ --> </p>
                                          <p class="text ">
